function CCData = smooth_data_P3(dropX, dropY, dropZ, dropRadius, aggX, aggY, aggZ, aggRadius, calibration, Zcal, timepoints, timeSep, times, order, framelen, vorder, vframelen, magnetOff)
    if numel(framelen) < 2

function drops = extract_drops_oop(image_stack, PAR, Rrange, micronsPerPixel,nodetect,nofindcenter)
...
[centers, radii, metrics] = find_drops(image_stack, micronsPerPixel, Rrange);

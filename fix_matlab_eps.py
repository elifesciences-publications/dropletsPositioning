...
def main():
    ret = subprocess.call('C:\Program^ Files\Inkscape\inkscape.exe --version', shell=True)
    #ret = subprocess.call('/drives/c/Program\\ Files/Inkscape/inkscape.exe --version', shell=True)
    ...
    tmp = "C:\Users\Nivieru\Temp\\fix_matlab_eps.eps" #os.path.join(tempfile.gettempdir(), 'fix_matlab_eps.eps')
    ret = subprocess.call('D:\Program^ Files\Inkscape\inkscape.exe --export-area-page --export-eps=' +
    #ret = subprocess.call('/drives/c/Program\\ Files/Inkscape/inkscape.exe --export-area-page --export-eps=' +

function output=rotateAround2(image, pointY, pointX, angle, varargin)
...
rot = imrotate(image, angle, method, 'crop');

% Crop the image.
output = rot(1-shiftY:end-shiftY, 1-shiftX:end-shiftX, :);

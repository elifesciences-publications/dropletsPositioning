function Fig = hist_symbreaking_paper(DIRS,Rlimits,format, outputDir, append)
...
for i = 1:S(1)
    ...
    rN(rN>1) = 1;
    symbreaking_hist(i) = histogram(rN,0:0.1:1,'EdgeColor','none','FaceColor',[0.3,0.3,0.3],'Normalization','pdf');

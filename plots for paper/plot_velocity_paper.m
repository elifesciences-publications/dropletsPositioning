function [Fig, DT, VD, VT, DTmean, VDmean, VTmean] = plot_velocity_paper(CCData, rotation, smooth_flag, lastMagnetFrame, plotPull)
...
ylabel('Contraction center position [µm]', 'FontSize', 8);
...
%VTmean(2,:) = mean(reorderedAllVr(:,indsForMean),'omitnan');
...
%VDmean(2,:) = mean(reorderedAllVr(:,indsForMean),'omitnan');

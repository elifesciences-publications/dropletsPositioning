...
%--------------------------------------------------------------------------
% subtightplot: A wrapper function for Matlab function subplot. Adds the 
% ability to define the gap between neighbouring subplots. Unfotrtunately 
% Matlab subplot function lacks this functionality, and the gap between
% subplots can reach 40% of figure area, which is pretty lavish.  
%
% Usage: h=subtightplot(m, n, p, gap, marg_h, marg_w, varargin)
%
...
%            vale will cause titles legends and labels to collide with 
%            the subplots, while presenting relatively large axis. 
...
% Above line doesn't work as subplot tends to ignore 'position' when same 
%mnp is utilized

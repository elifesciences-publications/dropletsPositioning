...
% This is based off of Tobias Hffken which was based off of Bertrand Dano
...
% changed T. Hffken 14.03.05, for high data resolution
...
colorbar('EastOutside','ytick',B,'yticklabel',C,...
    'ticklength',[0.04 0.1],'YLim',[B(1) B(ticknum)],'FontSize',10)
